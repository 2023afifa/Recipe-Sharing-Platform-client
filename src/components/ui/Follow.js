...
const Follow = () => {
    return (
        <div className='mb-14 px-3 lg:px-10 py-5 bg-slate-900 text-slate-200 gap-6 flex flex-col md:flex-row md:justify-evenly md:items-center'>
            <div>
                <h2 className='text-3xl text-center mb-5'>Follow us</h2>
            ...
            <div className='relative mx-auto'>
                ...
                <div className='hero-overlay absolute text-center text-2xl font-semibold w-full h-16 py-3 bg-opacity-40 text-slate-100 sm:top-20 md:top-14 lg:top-20'>Top Recipes Cook Book</div>
            </div>
        </div>
    );
};
