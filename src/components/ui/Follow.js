...
const Follow = () => {
    return (
        <div className='mb-14 py-5 bg-slate-900 text-slate-200 flex justify-evenly items-center'>
            <div>
            ...
            <div className='relative'>
                ...
                <div className='hero-overlay absolute text-center text-2xl font-semibold w-full h-16 py-3 bg-opacity-40 text-slate-100 lg:top-20'>Top Recipes Cook Book</div>
            </div>
        </div>
    );
};
